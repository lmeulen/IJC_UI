...
public class WedstrijdschemaDialoog extends JDialog {
    ...
    WedstrijdschemaDialoog(Frame frame, String title, int groepID) {
        ...
        Utils.fixedColumSize(spelersTabel.getColumnModel().getColumn(1), 155);
        Utils.fixedColumSize(spelersTabel.getColumnModel().getColumn(2), 35);
        Utils.fixedColumSize(spelersTabel.getColumnModel().getColumn(3), 35);
        Utils.fixedColumSize(spelersTabel.getColumnModel().getColumn(4), 35);
        Utils.fixedColumSize(spelersTabel.getColumnModel().getColumn(5), 35);
